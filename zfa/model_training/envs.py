...
def swimmer3(
    ...
    return swimmer._make_swimmer(
        n_links, time_limit, random=random, environment_kwargs=environment_kwargs
    )


# adapted to gymnasium from: https://github.com/zuoxingdong/dm2gym/blob/master/dm2gym/envs/dm_suite_env.py
        ...
        if mode == "rgb_array":
            ...
            if self.viewer is None:
                if not use_opencv_renderer:
                    self.viewer = SimpleImageViewer(maxwidth=1024)
                else:
...
# from: https://github.com/carlosluis/gym/blob/cabd8cd67ee551c85719bcb59f392765a2181bd0/gym/utils/pyglet_rendering.py
"""
