...
srun python /om2/user/leokoz8/code/virtual_zebrafish/zfa/data_comparisons/leo-inter-animal-percentile-map.py --train-frac=0.5 --num-parallel-jobs=25 --source_cell_type="glial" --target_cell_type="neural" --num-bootstrap-iters=100 --job_ID=$SLURM_ARRAY_TASK_ID --source_animal=0 --target_animal=1